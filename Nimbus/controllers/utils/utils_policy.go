...
func BuildKubeArmorPolicySpec(ctx context.Context, bindingInfo *general.BindingInfo) *kubearmorpolicyv1.KubeArmorPolicy {
	...
	return &kubearmorpolicyv1.KubeArmorPolicy{
		...
		Spec: kubearmorpolicyv1.KubeArmorPolicySpec{
			...
			Process:      ConvertToKubeArmorPolicyProcessType(bindingInfo),
			File:         ConvertToKubeArmorPolicyFileType(bindingInfo),
			Capabilities: ConvertToKubeArmorPolicyCapabilitiesType(bindingInfo),
			Network:      ConvertToKubeArmorPolicyNetworkType(bindingInfo),
...
func ConvertToKubeArmorPolicyProcessType(bindingInfo *general.BindingInfo) kubearmorpolicyv1.ProcessType {
	intent := bindingInfo.Intent[0]
...
func ConvertToKubeArmorPolicyFileType(bindingInfo *general.BindingInfo) kubearmorpolicyv1.FileType {
	intent := bindingInfo.Intent[0]
...
func ConvertToKubeArmorPolicyCapabilitiesType(bindingInfo *general.BindingInfo) kubearmorpolicyv1.CapabilitiesType {
...
func ConvertToKubeArmorPolicyNetworkType(bindingInfo *general.BindingInfo) kubearmorpolicyv1.NetworkType {
