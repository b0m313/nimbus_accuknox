...
func (spc *SystemPolicyController) DeletePolicy(ctx context.Context, bindingInfo *general.BindingInfo) error {
	...
	err := deleteSystemPolicy(ctx, spc.Client, "KubeArmorPolicy", bindingInfo.Binding.Name, bindingInfo.Binding.Namespace)
	if err != nil {
...
// deleteSystemPolicy helps in deleting a specified system policy.
