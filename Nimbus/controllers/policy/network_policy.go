...
func (npc *NetworkPolicyController) DeletePolicy(ctx context.Context, bindingInfo *general.BindingInfo) error {
	...
	err = deleteNetworkPolicy(ctx, npc.Client, "CiliumNetworkPolicy", bindingInfo.Binding.Name, bindingInfo.Binding.Namespace)
	if err != nil {
...
func createCiliumNetworkPolicy(ctx context.Context, bindingInfo *general.BindingInfo) *ciliumv2.CiliumNetworkPolicy {
	return utils.BuildCiliumNetworkPolicySpec(ctx, bindingInfo).(*ciliumv2.CiliumNetworkPolicy)
}
